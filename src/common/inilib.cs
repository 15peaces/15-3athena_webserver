...
namespace inilib
{
    class IniHandle
    {
        ...
        public string ReadIniField(int[] group_index, string key, string _default, int min, int max)
        {
        ...
        public string ReadIniField(int[] group_index, string key, string _default)
        {
            return ReadIniField(group_index, key, _default, int.MinValue, int.MaxValue);
        }
    }
}